...
In such contexts, we can make pairing application practical by using an efficient proof system to verify the correctness of the pairing computation, rather than executing all operations natively within the expensive environment.
