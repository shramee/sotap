...
\begin{itemize}
\item \textbf{29\% reduction} in SCS constraints (1,447,170~$\to$~1,026,241 for BN254 2-pairing)
\item \textbf{48\% reduction} in commitments (539,884~$\to$~281,518), the dominant cost in recursive proof systems
\item \textbf{34\% reduction} in compile-time memory and \textbf{44\%} in solver memory
\end{itemize}
