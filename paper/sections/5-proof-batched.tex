...
\end{itemize}
By the Schwartz-Zippel lemma, the probability that the non-zero polynomial $P_{\mathrm{err}}$ evaluates to zero is bounded by the sum of its maximum degrees divided by the field size:
...
\textbf{Non-interactive proof via Fiat-Shamir}: Under the random oracle model the
